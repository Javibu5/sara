...
import {
  ProjectDeadlineWasUpdated,
  ProjectDeadlineWasUpdatedProps,
} from './project-deadline-was-updated.event';
import {
  ProjectDescriptionWasUpdated,
  ProjectDescriptionWasUpdatedProps,
} from './project-description-was-update.event';
import {
  ProjectNameWasUpdated,
  ProjectNameWasUpdatedProps,
} from './project-name-was-updated.event';
import {
  ProjectStatusWasUpdated,
  ProjectStatusWasUpdatedProps,
} from './project-satus-was-updated.event';
import {
  ProjectWasCreated,
  ProjectWasCreatedProps,
} from './project-was-created.event';
...
export const eventTransformers = {
  ...
  ProjectDescriptionWasUpdated: (
    event: Event<ProjectDescriptionWasUpdatedProps>
  ) =>
